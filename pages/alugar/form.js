            ...
            <Container>
                ...
                <Form>
                    <Form.Group className="mb-3" controlId="tipo">
                        <Form.Label> Você está alugando:</Form.Label>
                    ...
                    <Form.Group className="mb-3" controlId="pets">
                        <Form.Label> Aceita pets?</Form.Label>
                        <Form.Select aria-label="Default select example" isInvalid={errors.pets} {...register('pets', aluguelValidator.preferencia)} >
